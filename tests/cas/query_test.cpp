...
TEST_CASE("Test Path Only Queries", "[cas::Query]") {
  auto approach = GENERATE(
      benchmark::Approach{cas::IndexType::DynamicInterleaving, "dy"},
      benchmark::Approach{cas::IndexType::PathValue, "pv"},
      benchmark::Approach{cas::IndexType::ValuePath, "vp"},
      benchmark::Approach{cas::IndexType::LabelWise, "lw"},
      benchmark::Approach{cas::IndexType::Xml, "xml"},
      benchmark::Approach{cas::IndexType::ZOrder, "zo", true, 10, 2}
  );
  auto index = benchmark::CreateIndex<cas::vint64_t>(approach);
...
TEST_CASE("Test Value Only Queries", "[cas::Query]") {
  ...
  auto index = benchmark::CreateIndex<cas::vstring_t>(approach);
